...
class Informer(nn.Module):
    def __init__(self, c_out, factor=5, d_model=512, n_heads=8, e_layers=1, d_ff=512,
        ...
        self.projection = nn.Linear(numwidows*3335, c_out, bias=True)
...
def Informerencoder():
    model = Informer(c_out=2, factor=5,d_model=numwidows, n_heads=4, e_layers=3, dropout=0.5)
...
print(x)
# input_matrix = torch.ones((1,6640,24))
# x,attn=model(input_matrix,attn_mask=None)

# print(torch.ones((1,3,5)))
# print(x.shape)
# print(attn)